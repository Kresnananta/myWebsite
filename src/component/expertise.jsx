			...
			<section id='expertise' className='py-20 md:py-32 bg-slate-50 dark:bg-slate-800/50 transition-colors'>
				<div className='max-w-6xl mx-auto px-6'>
					...
					<div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
						{/* 1 */}
						<div className='bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-2xl hover:shadow-amber-500/10 dark:hover:shadow-indigo-500/10 hover:-translate-y-2 transition-all duration-300 group'>
